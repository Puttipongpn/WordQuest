...
export const WORD_FATIGUE_RESTING_THRESHOLD = 5;
export const WORD_FATIGUE_FRESH_WEIGHT = 5;
export const WORD_FATIGUE_USED_WEIGHT = 3;
export const WORD_FATIGUE_TIRED_WEIGHT = 2;
